...
extern "C" void RunRayTracerWithTexture(uchar4* dest, const int imageW, const int imageH, const int xThreadsPerBlock, const float3 a_vCameraPosition, const float3 cameraForward, const float3 cameraUp, const float3 cameraRight, const float a_fNearPlaneDistance);
